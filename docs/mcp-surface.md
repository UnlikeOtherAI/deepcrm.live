...
| `crm_template_apply` | Apply a schema template by slug (see crm://templates), e.g. standard_crm, standard_sales, or standard_service. Idempotent: existing slugs untouched. Unknown slug ⇒ UNKNOWN_TEMPLATE {available}. | `{ template: string }` | `{ added: { object_types, attributes, relation_types, pipelines, matching_rules } }` (numeric counts) |
<!-- tools:end -->
